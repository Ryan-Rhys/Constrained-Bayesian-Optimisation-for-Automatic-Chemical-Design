"""
Network layer class for the Bayesian Neural Network modelling the constraint.
"""
...
class Network_layer:
    ...
    def output(self, x):
        ...
        if not self.output_layer:
            o = T.nnet.relu(a)
            #o = T.exp(-a**2) # 1 August 11:58 - trying Gaussian activations.
        else:
            a = a - a.max(axis=2, keepdims=True)
            o = a - T.log(T.sum(T.exp(a), axis=2, keepdims=True))  # output is log of the softmax
