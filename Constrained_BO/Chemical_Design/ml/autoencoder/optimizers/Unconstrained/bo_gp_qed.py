...
molecules that are optimised for QED, SA and don't incur a ring-penalty.
"""
...
for iteration in range(num_iters):
    ...
    save_object(valid_sens_smiles_final, "results_QED_comp/valid_sens_smiles{}.dat".format(iteration))

    qed_values = np.loadtxt('../qed_features_and_targets/qed_values.txt')
    SA_scores = np.loadtxt('../qed_features_and_targets/SA_scores.txt')
    cycle_scores = np.loadtxt('../qed_features_and_targets/cycle_scores.txt')
